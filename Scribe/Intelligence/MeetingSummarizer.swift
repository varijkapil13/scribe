...
//
// `MeetingSummary` and `ActionItem` now live in `MeetingModels.swift` (pure
// Foundation) so the iOS target can persist/display them without compiling
// this device-gated summarizer.
